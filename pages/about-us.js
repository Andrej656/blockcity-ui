        ...
        <div className="row">
            ...
            <div data-wow-delay="0s" className="wow fadeInUp col-md-4">
                <div className="box-icon-item">
                    ...
                    <p>Passive income made easy! HODL to earn yields in Layer1 Bitcoin </p>
                </div>
            </div>
            ...
            <div data-wow-delay="0.1s" className="wow fadeInUp col-md-4">
                <div className="box-icon-item">
                    ...
                    <p>Secure your Ordinals transactions and passive income with Bitcoin finality.</p>
                </div>
            </div>
            <div data-wow-delay="0.1s" className="wow fadeInUp col-md-4">
                <div className="box-icon-item">
                    ...
                    <p>Every collector engaging with our platform is eligible to receive a profit.</p>
                </div>
            </div>
